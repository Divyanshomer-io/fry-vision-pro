...
// Typed payload item for tooltip
...
const ChartTooltipContent = React.forwardRef<
  ...
  React.ComponentProps<"div"> & {
    ...
    formatter?: (value: string | number | undefined, name: string | number | undefined, item: TooltipPayloadItem, index: number, payload: TooltipPayloadItem[]) => React.ReactNode;
    color?: string;
    nameKey?: string;
    labelKey?: string;
    hideLabel?: boolean;
